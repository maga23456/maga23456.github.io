    ...
    <div class="container-fluid" style="margin-top: 10px;">
      ...
      <div id="center" class="jumbotron p-3 p-md-5 text-white rounded bg-dark" style="background-color: white !important; border: 4px double black;">
          <div class="col-md-12 px-0">
            ...
            <p class="lead my-3" align="center" style="color: black;">В каждой стране, а у каждого народа имеются собственные секреты приготовления тех или иных блюд. В этой рубрике мы постарались собрать наиболее полную коллекцию рецептов из национальных кухонь мира.</p>  
         </div>
        </div>
      </div>
